...
const reset = document.querySelector('#right-container #button-reset');
const inputs = document.querySelectorAll('.input');
const resultTip = document.querySelector('#result-tip');
const resultTotal = document.querySelector('#result-total');
const bill = document.querySelector('main #left-container #bill .input');
const numberOfPeople = document.querySelector('main #left-container-bottom #number-people .input');
